...
import 'package:fleetgo/presentation/screens/auth/signup/complete_signup.dart';
import 'package:fleetgo/presentation/widgets/circular_indicator.dart';
import 'package:fleetgo/presentation/widgets/pinput.dart';
...
class _OtpVerificationState extends State<OtpVerification> {
  ...
  Future<void> userSignUpEmail(
    ...
    context.read<SignUpBloc>().add(SignUpEmail(user, password, email));
  }

  Future<void> userSignUpPhone(String email, String phone, String password,
    ...
    context.read<SignUpBloc>().add(SignUpPhone(user: user, smsOtp: smsOtp));
  }
                          ...
                          listener: (context, state) async {
                            if (state is EmailVerificationFailure) {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (ctx) => const CompleteSignup(),
                              ));
                            }
                          },
                        )
