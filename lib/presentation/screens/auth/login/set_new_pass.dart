...
import 'package:fleetgo/resources/regx/regexp.dart';
...
class _SetNewPassState extends State<SetNewPass> {
  ...
  Widget build(BuildContext context) {
    ...
    context.read<PasswordVisibilityBloc>().add(const ResetPasswordVisibility(currentPasswordFieldId));
    context.read<PasswordVisibilityBloc>().add(const ResetPasswordVisibility(newPasswordFieldId));
    context.read<PasswordVisibilityBloc>().add(const ResetPasswordVisibility(confirmPasswordFieldId));
                ...
                BlocBuilder<PasswordVisibilityBloc, PasswordVisibilityChange>(
                  builder: (context, state) {
                    return InputBox(
                      ...
                      obscureText: !context.read<PasswordVisibilityBloc>().isFieldVisible(currentPasswordFieldId),
                      validator: (value) {
                      ...
                      iconSuffix: IconButton(
                        icon: Icon(
                          context.read<PasswordVisibilityBloc>().isFieldVisible(currentPasswordFieldId)
                              ? Icons.visibility
                        ...
                        onPressed: () {
                          context.read<PasswordVisibilityBloc>().add(
                            const TogglePasswordVisibility(currentPasswordFieldId),
                          );
                        },
                      ),
                    );
                ...
                BlocBuilder<PasswordVisibilityBloc, PasswordVisibilityChange>(
                  builder: (context, state) {
                    return InputBox(
                      ...
                      obscureText: !context.read<PasswordVisibilityBloc>().isFieldVisible(newPasswordFieldId),
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                      ...
                      iconSuffix: IconButton(
                        icon: Icon(
                          context.read<PasswordVisibilityBloc>().isFieldVisible(newPasswordFieldId)
                              ? Icons.visibility
                              : Icons.visibility_off,
                          size: 15,
                        ),
                        onPressed: () {
                          context.read<PasswordVisibilityBloc>().add(
                            const TogglePasswordVisibility(newPasswordFieldId),
                          );
                        },
                      ),
                    );
                ...
                BlocBuilder<PasswordVisibilityBloc, PasswordVisibilityChange>(
                  builder: (context, state) {
                    return InputBox(
                      ...
                      obscureText: !context.read<PasswordVisibilityBloc>().isFieldVisible(confirmPasswordFieldId),
                      validator: (value) {
                      ...
                      iconSuffix: IconButton(
                        icon: Icon(
                          context.read<PasswordVisibilityBloc>().isFieldVisible(confirmPasswordFieldId)
                              ? Icons.visibility
                              : Icons.visibility_off,
                          size: 15,
                        ),
                        onPressed: () {
                          context.read<PasswordVisibilityBloc>().add(
                            const TogglePasswordVisibility(confirmPasswordFieldId),
                          );
                        },
                      ),
                    );
